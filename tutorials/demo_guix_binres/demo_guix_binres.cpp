...
VOID demo_thread_entry(ULONG thread_input)
{
    ...
    root->canvas->memory = default_canvas_memory;
    ...
    binres_root_address = (GX_UBYTE*)load_binary_resource_data_to_ram();
#endif
...
UINT  status = GX_SUCCESS;
    ...
    {
        /* Set language table. */
        gx_display_language_table_set_ext(root->canvas->display, (GX_CONST GX_STRING **)language_table, MAIN_DISPLAY_LANGUAGE_TABLE_SIZE, MAIN_DISPLAY_STRING_TABLE_SIZE);
