...
{
    INT temperature;
    GX_RADIAL_SLIDER_INFO* info = &temperature_window.temperature_window_temperature_slider.info;

    /* Convert angle value to temperature value.  */
    temperature = (info->current_angle - info->min_angle) *
...
UINT temperature_window_event_process(GX_WINDOW* window, GX_EVENT* event_ptr)
{
    ...
    case GX_EVENT_SHOW:
    {
        ...
        gx_radial_slider_angle_set(slider, info->max_angle);
