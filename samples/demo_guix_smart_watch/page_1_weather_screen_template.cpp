...
/******************************************************************************************/
static VOID update_one_day_weather_info(WEATHER_INFO_TEMPLATE_CONTROL_BLOCK* tmpl, WEATHER_INFO* info)
{
    gx_prompt_text_id_set(&tmpl->weather_info_template_day_of_week, info->day_of_week_text_id);
    gx_icon_pixelmap_set(&tmpl->weather_info_template_weather_icon, info->weather_icon_id, info->weather_icon_id);
    gx_numeric_prompt_value_set(&tmpl->weather_info_template_high_temperature, info->high_temperature);
    gx_numeric_prompt_value_set(&tmpl->weather_info_template_low_temperature, info->low_temperature);
}

/******************************************************************************************/
/* Update screen weather information.                                                     */
/******************************************************************************************/
static VOID update_screen_weather_info(WEATHER_SCREEN_TEMPLATE_CONTROL_BLOCK *tmpl)
{
    ...
    update_one_day_weather_info(&tmpl->weather_screen_template_day_win_1, &info_list[0]);
    update_one_day_weather_info(&tmpl->weather_screen_template_day_win_2, &info_list[1]);
    update_one_day_weather_info(&tmpl->weather_screen_template_day_win_3, &info_list[2]);
    update_one_day_weather_info(&tmpl->weather_screen_template_day_win_4, &info_list[3]);
    update_one_day_weather_info(&tmpl->weather_screen_template_day_win_5, &info_list[4]);
    update_one_day_weather_info(&tmpl->weather_screen_template_day_win_6, &info_list[5]);
    update_one_day_weather_info(&tmpl->weather_screen_template_day_win_7, &info_list[6]);
}
