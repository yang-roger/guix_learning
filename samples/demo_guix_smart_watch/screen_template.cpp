...
/******************************************************************************************/
static VOID update_title_clock(SCREEN_TEMPLATE_CONTROL_BLOCK *tmpl)
{
    screen_clock_update(&tmpl->screen_template_hour, &tmpl->screen_template_minute, &tmpl->screen_template_second);
}
