...
static void clock_slide_animation_start()
{
    ...
    {
        target_hour_end_pos.x = TARGET_HOUR_MAX_XPOS;
        target_hour_end_pos.y = TARGET_HOUR_MAX_YPOS;
        target_minute_end_pos.x = TARGET_MINIUTE_MIN_XPOS;
        target_minute_end_pos.y = TARGET_MINIUTE_MIN_YPOS;
    }
    else
    {
        target_hour_end_pos.x = TARGET_HOUR_MIN_XPOS;
        target_hour_end_pos.y = TARGET_HOUR_MIN_YPOS;
        target_minute_end_pos.x = TARGET_MINIUTE_MAX_XPOS;
        target_minute_end_pos.y = TARGET_MINIUTE_MAX_YPOS;
    }

    memset(&info, 0, sizeof(GX_ANIMATION_INFO));
    info.parent = (GX_WIDGET*)&clock_5_screen;
    ...
    info.end_position = target_hour_end_pos;
    ...
    info.end_position = target_minute_end_pos;
...
VOID clock_5_screen_draw(GX_WINDOW* window)
{
    ...
    xcenter = size->left + width * 3 / 5;
    ycenter = size->top + height * 3 / 5;
