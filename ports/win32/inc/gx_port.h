...
#define GX_WIN32_EVENT_THREAD_CREATE(driver_data, thread_name) driver_data->thread_handle = CreateThread(NULL, GX_WIN32_STACK_SIZE, (LPTHREAD_START_ROUTINE)gx_win32_driver_thread_entry, driver_data, 0, 0);
...
#define GX_CALLER_CHECKING_EXTERNS          GX_EXTERN_C TX_THREAD           *_tx_thread_current_ptr; \
                                            GX_EXTERN_C TX_THREAD           _tx_timer_thread; \
                                            GX_EXTERN_C volatile ULONG      _tx_thread_system_state;
...
CHAR _gx_version_id[] =
    "(c) 2024 Microsoft Corp. (c) 2026 Eclipse ThreadX contributors.  *  GUIX Win32/Visual Version 6.5.1.202602 *";
#else
