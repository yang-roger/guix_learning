...
GX_UBYTE           b;
    ...
    blend_function = display->driver_pixel_blend;
    write_function = display->driver_pixel_write;
...
VOID _gx_dave2d_simulation_display_driver_16bpp_pixelmap_draw(GX_DRAW_CONTEXT *context,
                                                               INT xpos, INT ypos, GX_PIXELMAP *pixelmap)
{
    _gx_dave2d_simulation_display_driver_565rgb_pixelmap_blend(context, xpos, ypos, pixelmap, context->brush.alpha);
}
