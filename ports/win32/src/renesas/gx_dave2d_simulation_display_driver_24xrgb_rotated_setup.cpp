                                                                                        ...
                                                                                        GX_RECTANGLE *dirty_area))
{
    ...
    display->driver_pixelmap_draw                 = _gx_dave2d_simulation_display_driver_24xrgb_rotated_pixelmap_draw;
    display->driver_pixelmap_blend                = _gx_dave2d_simulation_display_driver_24xrgb_rotated_pixelmap_blend;
    display->driver_4bit_glyph_draw               = _gx_dave2d_simulation_display_driver_rotated_glyph_4bit_draw;
    display->driver_1bit_glyph_draw               = _gx_dave2d_simulation_display_driver_32bpp_rotated_glyph_1bit_draw;
    ...
    display->driver_1bit_compressed_glyph_draw    = _gx_dave2d_simulation_display_driver_32bpp_rotated_compressed_glyph_1bit_draw;
    display->driver_horizontal_pixelmap_line_draw = _gx_dave2d_simulation_display_driver_32bpp_rotated_horizontal_pixelmap_line_draw;
}
