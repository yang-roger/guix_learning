...
/*  FUNCTION                                               RELEASE        */
/*                                                                        */
/*    _gx_dave2d_s_display_driver_565rgb_setup                            */
/*                                                           6.4.0        */
/*  AUTHOR                                                                */
/*                                                                        */
                                                                                ...
                                                                                GX_RECTANGLE *dirty_area))
{
    ...
    display->driver_pixelmap_draw                 = _gx_dave2d_simulation_display_driver_16bpp_pixelmap_draw;
    display->driver_pixelmap_blend                = _gx_dave2d_simulation_display_driver_565rgb_pixelmap_blend;
    display->driver_4bit_glyph_draw               = _gx_dave2d_simulation_display_driver_glyph_4bit_draw;
    display->driver_1bit_glyph_draw               = _gx_dave2d_simulation_display_driver_16bpp_glyph_1bit_draw;
    ...
    display->driver_1bit_compressed_glyph_draw    = _gx_dave2d_simulation_display_driver_16bpp_compressed_glyph_1bit_draw;
    display->driver_horizontal_pixelmap_line_draw = _gx_dave2d_simulation_display_driver_565rgb_horizontal_pixelmap_line_draw;
}
