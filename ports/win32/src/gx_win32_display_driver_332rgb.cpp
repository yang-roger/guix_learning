...
/*  FUNCTION                                               RELEASE        */
/*                                                                        */
/*    win32_332rgb_bitmap_header_create                                   */
/*                                                           6.1.3        */
/*  AUTHOR                                                                */
/*                                                                        */
...
GX_WIN32_DISPLAY_DRIVER_DATA *instance = (GX_WIN32_DISPLAY_DRIVER_DATA *)display->driver_data;
    ...
    instance->bmpinfo.header.biClrUsed = 256;
    instance->bmpinfo.header.biClrImportant = 256;
    ...
    for (r = 0; r < 8; r++)
    {
        ...
        for (g = 0; g < 8; g++)
        {
            ...
            for (b = 0; b < 4; b++)
            {
                ...
                instance->bmpinfo.colors[i] = color;
                i++;
            }
        }
    }
...
GX_WIN32_DISPLAY_DRIVER_DATA *data;
    ...
    data->type = GX_COLOR_FORMAT_8BIT_PACKED_PIXEL;
