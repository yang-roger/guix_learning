...
extern VOID _gx_chromart_simulation_display_driver_565rgb_setup(GX_DISPLAY *display, VOID *aux_data,
...
/*                                                                        */
/**************************************************************************/
static void win32_565rgb_bitmap_header_create(GX_DISPLAY *display)
{
DWORD                        *putmask;
...
/*  DESCRIPTION                                                           */
/*                                                                        */
/*    This function creates a Windows specific 565rgb chromart simulation */
/*    display driver.                                                     */
/*                                                                        */
/*  INPUT                                                                 */
/*                                                                        */
...
GX_WIN32_DISPLAY_DRIVER_DATA *data;
    ...
    /* Set display color format type. */
    data->type = GX_COLOR_FORMAT_565RGB;

    _gx_chromart_simulation_display_driver_565rgb_setup(display, data, gx_win32_display_buffer_toggle);

    win32_565rgb_bitmap_header_create(display);
