...
/*  FUNCTION                                               RELEASE        */
/*                                                                        */
/*    win32_monochrome_bitmap_header_create                               */
/*                                                           6.1.3        */
/*  AUTHOR                                                                */
/*                                                                        */
...
GX_WIN32_DISPLAY_DRIVER_DATA *instance = (GX_WIN32_DISPLAY_DRIVER_DATA *)display->driver_data;
    ...
    instance->bmpinfo.header.biBitCount = 1;
    instance->bmpinfo.header.biSizeImage = (display->width * display->height) >> 3;
    instance->bmpinfo.header.biClrUsed = 2;
    instance->bmpinfo.header.biClrImportant = 2;
    instance->bmpinfo.header.biCompression = BI_RGB;

    instance->bmpinfo.colors[0] = 0xff000000;
    instance->bmpinfo.colors[1] = 0xffffffff;
}
...
GX_WIN32_DISPLAY_DRIVER_DATA *data;
    ...
    data->type = GX_COLOR_FORMAT_MONOCHROME;
