...
/*  FUNCTION                                               RELEASE        */
/*                                                                        */
/*    win32_display_driver_8bit_palette_set                               */
/*                                                           6.1.4        */
/*  AUTHOR                                                                */
/*                                                                        */
...
GX_WIN32_DISPLAY_DRIVER_DATA *instance;
    ...
    display->palette_size = count;

    instance = (GX_WIN32_DISPLAY_DRIVER_DATA *)display->driver_data;
    instance->bmpinfo.header.biClrUsed = count;
    instance->bmpinfo.header.biClrImportant = count;
...
GX_WIN32_DISPLAY_DRIVER_DATA *instance = (GX_WIN32_DISPLAY_DRIVER_DATA *)display->driver_data;
    ...
    instance->bmpinfo.header.biBitCount = 8;
    instance->bmpinfo.header.biSizeImage = display->width * display->height;
    instance->bmpinfo.header.biClrUsed = 0;
    instance->bmpinfo.header.biClrImportant = 0;
...
GX_WIN32_DISPLAY_DRIVER_DATA *data;
    ...
    data->type = GX_COLOR_FORMAT_8BIT_PALETTE;

    _gx_display_driver_8bit_palette_setup(display, data, gx_win32_display_buffer_toggle);
    display->driver_palette_set = win32_display_driver_8bit_palette_set;
