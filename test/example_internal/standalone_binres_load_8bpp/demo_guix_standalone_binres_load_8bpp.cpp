...
UINT load_standalone_pixelmaps()
{
    ...
    {
        status = gx_binres_pixelmap_load((GX_UBYTE*)root_address_pixelmap_folder_1, index, &pixelmap_folder_1[index]);
    ...
    status = gx_binres_pixelmap_load((GX_UBYTE*)root_address_pixelmap_fish, 0, &pixelmap_fish);
...
VOID pixelmap_draw(GX_WINDOW* window)
{
    ...
    xpos = size->right - (pixelmap_folder_1[1].width);
    gx_canvas_pixelmap_draw(xpos, ypos, &pixelmap_folder_1[1]);

    xpos = size->left;
    ypos = size->bottom - (pixelmap_folder_1[2].height);
    gx_canvas_pixelmap_draw(xpos, ypos, &pixelmap_folder_1[2]);

    xpos = size->right - (pixelmap_fish.width);
