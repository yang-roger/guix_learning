...
#define DROP_LIST_TOTAL_ROWS 100
...
extern GX_STUDIO_DISPLAY_INFO all_widgets_1555xrgb_display_table[];
...
DROP_LIST_WIDGET drop_list_widgets[DROP_LIST_TOTAL_ROWS];
...
extern UINT win32_graphics_driver_setup_1555xrgb(GX_DISPLAY *display);
...
VOID  demo_thread_entry(ULONG thread_input)
{
    ...
    gx_studio_display_configure(MAIN_DISPLAY, win32_graphics_driver_setup_1555xrgb, 
    ...
    gx_studio_named_widget_create("rotate_screen", (GX_WIDGET *)root, (GX_WIDGET **)&pRotateScreen);
    ...
    gx_canvas_create(&composite_canvas, GX_NULL,
        all_widgets_1555xrgb_display_table[0].display,
        GX_CANVAS_COMPOSITE,
