...
#include <stdio.h>
#include "gx_api.h"
#include "all_widgets_resources.h"
#include "all_widgets_specifications.h"
...
extern GX_STUDIO_DISPLAY_INFO all_widgets_display_table[];
...
VOID demo_thread_entry(ULONG thread_input)
{
    ...
    gx_canvas_create(&composite_canvas, GX_NULL,
        all_widgets_display_table[0].display,
        GX_CANVAS_COMPOSITE,
        root->size.right - root->size.left + 1,
        root->size.bottom - root->size.top + 1,
