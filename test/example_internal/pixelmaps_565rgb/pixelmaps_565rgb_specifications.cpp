...
GX_STUDIO_DISPLAY_INFO pixelmaps_565rgb_display_table[1] =
{
    {
    "display_1",
    "display_1_canvas",
...
GX_CONST GX_STUDIO_WIDGET_ENTRY pixelmaps_565rgb_widget_table[] =
{
...
{
    return gx_studio_named_widget_create_from_table(name, parent, new_widget, pixelmaps_565rgb_widget_table);
}
...
{
    GX_STUDIO_DISPLAY_INFO *display_info = &pixelmaps_565rgb_display_table[display];
