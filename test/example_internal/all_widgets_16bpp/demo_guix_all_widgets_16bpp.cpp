...
extern GX_STUDIO_DISPLAY_INFO all_widgets_16bpp_display_table[];
...
VOID  demo_thread_entry(ULONG thread_input)
{
    ...
    GX_CONST GX_CHAR ml_input_text[] = "multi line text input";
    GX_CONST GX_CHAR sl_input_text[] = "single line input";
    GX_STRING string;
    ...
    string.ptr = ml_input_text;
    string.length = sizeof(ml_input_text) - 1;
    gx_multi_line_text_input_text_set_ext(&widget_color_test_screen.widget_color_test_screen_ml_text_input, &string);

    string.ptr = sl_input_text;
    string.length = sizeof(sl_input_text) - 1;
    gx_single_line_text_input_character_insert(&widget_color_test_screen.widget_color_test_screen_sl_text_input, (GX_UBYTE *)string.ptr, string.length);
