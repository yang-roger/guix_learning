...
VOID  demo_thread_entry(ULONG thread_input)
{
    ...
    gx_studio_display_configure(MAIN_DISPLAY, win32_graphics_driver_setup_24xrgb_rotated,
...
GX_STRING string;
    ...
    _gx_utility_string_length_check(string.ptr, &string.length, sizeof(entry->text) - 1);
