...
GX_RESOURCE_ID  fill_pixelmap_id[4] = {GX_PIXELMAP_ID_ID_RAW, GX_PIXELMAP_ID_ID_COMPRESS, GX_PIXELMAP_ID_ID_ALPHA, GX_PIXELMAP_ID_ID_COMPRESS_ALPHA};
...
VOID update_prompt_value(GX_PROMPT *pp, INT value)
{
    ...
    if (pp)
    {
        ...
        string.ptr = str;
        string.length = strnlen(str, sizeof(str));
...
GX_WINDOW *pGraphicsWin = &(((SHAPES_SCREEN_CONTROL_BLOCK *)pShapesScreen)->shapes_screen_graphics_window);
    ...
    case GX_SIGNAL(ID_BRUSH_ALPHA, GX_EVENT_SLIDER_VALUE):
        ...
        prompt = &(((SHAPES_SCREEN_CONTROL_BLOCK *)pShapesScreen)->shapes_screen_prompt_14);
