...
#include "pixelmaps_565rgb_rotated_cw_resources.h"
#include "pixelmaps_565rgb_rotated_cw_specifications.h"
...
GX_RESOURCE_ID   maps[3][4] = { { GX_PIXELMAP_ID_RAW_565RGB, GX_PIXELMAP_ID_ALPHA_565RGB, GX_PIXELMAP_ID_COMPRESS_565RGB, GX_PIXELMAP_ID_COMPRESS_ALPHA_565RGB },
...
VOID  demo_thread_entry(ULONG thread_input)
{
    ...
    gx_studio_display_configure(DISPLAY_1, win32_graphics_driver_setup_565rgb_rotated,
