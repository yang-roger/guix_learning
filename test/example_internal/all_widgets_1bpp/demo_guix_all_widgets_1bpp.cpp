...
VOID  demo_thread_entry(ULONG thread_input)
{
    ...
    pic_window = &(pic_screen.pic_screen_pic_window);

    /* create the sprite screen */
    gx_studio_named_widget_create("sprite_screen", (GX_WIDGET *)root, GX_NULL);
...
UINT next_button_handler(GX_WINDOW *window, GX_EVENT *event_ptr)
{
    ...
    case GX_SIGNAL(IDB_NEXT, GX_EVENT_CLICKED):
        ...
        case ID_BUTTON_SCREEN:
            ...
            ToggleScreen(&window_screen, window);
            break;

        case ID_WINDOW_SCREEN:
            ToggleScreen(&text_screen, window);
            break;

        case ID_TEXT_SCREEN:
            ToggleScreen(&indicator_screen, window);
            break;

        case ID_INDICATOR_SCREEN:
            ToggleScreen(&shapes_screen, window);
            break;

        case ID_SHAPES_SCREEN:
            ToggleScreen(&pic_screen, window);
            break;
        ...
        case ID_MENU_SCREEN:
            ToggleScreen(&rotate_screen, window);
            break;
        ...
        case ID_RESIZE_SCREEN:
            ToggleScreen(&button_screen, window);
            break;
        }
        break;
...
VOID PopulateDropList(void)
{
    ...
    GX_DROP_LIST *drop = &window_screen.window_screen_drop_list;
