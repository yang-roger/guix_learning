...
GX_RADIAL_PROGRESS_BAR_INFO  *info = &progress_bar_window.progress_bar_window_radial_progress_bar.info;
...
GX_STRING str;
    ...
    case GX_SIGNAL(ID_NORMAL_WIDTH_SLIDER, GX_EVENT_SLIDER_VALUE):
        ...
        str.ptr = normal_width;
        str.length = strnlen(normal_width, sizeof(normal_width) - 1);
        gx_prompt_text_set_ext(&progress_bar_window.progress_bar_window_normal_width_prompt, &str);
        info->normal_brush_width = pos;
    ...
    case GX_SIGNAL(ID_SELECTED_WIDTH_SLIDER, GX_EVENT_SLIDER_VALUE):
        ...
        str.ptr = selected_width;
        str.length = strnlen(selected_width, sizeof(selected_width) - 1);
        gx_prompt_text_set_ext(&progress_bar_window.progress_bar_window_selected_width_prompt, &str);
        info->selected_brush_width = pos;
        gx_radial_progress_bar_info_set(progress_bar, info);
        break;
    ...
    case GX_SIGNAL(ID_RADIUS_SLIDER, GX_EVENT_SLIDER_VALUE):
        ...
        str.ptr = radius;
        str.length = strnlen(radius, sizeof(radius) - 1);
    ...
    case GX_SIGNAL(ID_ANCHOR_SLIDER, GX_EVENT_SLIDER_VALUE):
        ...
        str.ptr = anchor_value;
        str.length = strnlen(anchor_value, sizeof(anchor_value) - 1);
    ...
    case GX_SIGNAL(ID_ALPHA_SLIDER, GX_EVENT_SLIDER_VALUE):
        radial_progress_bar_alpha = event_ptr->payload.longdata;
...
GX_BRUSH *brush;
    ...
    brush->alpha = radial_progress_bar_alpha;
