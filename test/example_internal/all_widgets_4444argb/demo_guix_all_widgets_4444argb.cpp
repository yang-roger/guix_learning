...
extern GX_STUDIO_DISPLAY_INFO all_widgets_4444argb_display_table[];
...
VOID  demo_thread_entry(ULONG thread_input)
{
    ...
    gx_studio_display_configure(MAIN_DISPLAY, win32_graphics_driver_setup_4444argb, 
    ...
    gx_canvas_create(&composite_canvas, GX_NULL,
        all_widgets_4444argb_display_table[0].display,
        GX_CANVAS_COMPOSITE,
