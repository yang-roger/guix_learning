...
UINT load_language_table(const char *pathname);
...
UINT main_screen_event_process(GX_WINDOW *window, GX_EVENT *event_ptr)
{
    ...
    case GX_SIGNAL(ID_SWITCH_LANGUAGE, GX_EVENT_TOGGLE_OFF):
        ...
        {
            /* Set language table. */
            gx_display_language_table_set_ext(root->canvas->display, (GX_CONST GX_STRING **)language_table, 1, DISPLAY_1_STRING_TABLE_SIZE);
    ...
    case GX_SIGNAL(ID_SWITCH_LANGUAGE, GX_EVENT_TOGGLE_ON):
        gx_display_language_table_set_ext(root->canvas->display, display_1_language_table, DISPLAY_1_LANGUAGE_TABLE_SIZE, DISPLAY_1_STRING_TABLE_SIZE);
