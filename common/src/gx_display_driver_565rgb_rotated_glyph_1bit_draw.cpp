...
/*  FUNCTION                                               RELEASE        */
/*                                                                        */
/*    _gx_display_driver_565rgb_rotated_glyph_1bit_draw                   */
/*                                                           6.1.3        */
/*  AUTHOR                                                                */
/*                                                                        */
...
void     (*blend_func)(GX_DRAW_CONTEXT *, INT, INT, GX_COLOR, GX_UBYTE);
    ...
    pixel_per_row = (UINT)(draw_area->bottom - draw_area->top + 1);
    ...
    {
        rotated_draw_left = draw_area->top;
        rotated_draw_top = (GX_VALUE)(context->canvas->x_resolution - draw_area->right - 1);
    ...
    {
        rotated_draw_left = (GX_VALUE)(context->canvas->display_offset_y - draw_area->bottom - 1);
        rotated_draw_top = draw_area->left;

        rotated_map_offset_x = (GX_VALUE)(glyph->height - map_offset->y - (GX_VALUE)pixel_per_row);
    ...
    line_start = (USHORT *)context->memory;
    line_start += context->pitch * (rotated_draw_top);
