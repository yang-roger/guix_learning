...
static USHORT mouse_capture_memory[GX_MOUSE_MAX_RESOLUTION * GX_MOUSE_MAX_RESOLUTION] = { 0 };
#endif
/**************************************************************************/
/*                                                                        */
/*  FUNCTION                                               RELEASE        */
/*                                                                        */
/*    _gx_display_driver_565rgb_setup                                     */
/*                                                           6.1.3        */
/*  AUTHOR                                                                */
/*                                                                        */
                                                             ...
                                                             GX_RECTANGLE *dirty_area))
{
    ...
    display->mouse_capture                        = _gx_display_driver_16bpp_mouse_capture;
    display->mouse_restore                        = _gx_display_driver_16bpp_mouse_restore;
    ...
    display->color_format                         = GX_COLOR_FORMAT_565RGB;
    display->driver_canvas_copy                   = _gx_display_driver_16bpp_canvas_copy;
    display->driver_simple_line_draw              = _gx_display_driver_16bpp_simple_line_draw;
    display->driver_horizontal_line_draw          = _gx_display_driver_16bpp_horizontal_line_draw;
    display->driver_vertical_line_draw            = _gx_display_driver_16bpp_vertical_line_draw;
    display->driver_horizontal_pattern_line_draw  = _gx_display_driver_16bpp_horizontal_pattern_line_draw;
    display->driver_horizontal_pixelmap_line_draw = _gx_display_driver_565rgb_horizontal_pixelmap_line_draw;
    display->driver_vertical_pattern_line_draw    = _gx_display_driver_16bpp_vertical_pattern_line_draw;
    display->driver_pixel_write                   = _gx_display_driver_16bpp_pixel_write;
    display->driver_block_move                    = _gx_display_driver_16bpp_block_move;

    display->driver_native_color_get              = _gx_display_driver_565rgb_native_color_get;
    display->driver_row_pitch_get                 = _gx_display_driver_16bpp_row_pitch_get;
    display->driver_pixelmap_draw                 = _gx_display_driver_565rgb_pixelmap_draw;
    display->driver_pixelmap_rotate               = _gx_display_driver_16bpp_pixelmap_rotate;
    ...
    display->driver_canvas_blend                  = _gx_display_driver_565rgb_canvas_blend;
    display->driver_pixel_blend                   = _gx_display_driver_565rgb_pixel_blend;
    display->driver_pixelmap_blend                = _gx_display_driver_565rgb_pixelmap_blend;
    ...
    display->driver_1bit_glyph_draw               = _gx_display_driver_16bpp_glyph_1bit_draw;
    ...
    display->driver_jpeg_draw                     = _gx_display_driver_565rgb_jpeg_draw;
    display->driver_png_draw                      = _gx_display_driver_565rgb_png_draw;
#endif
}
