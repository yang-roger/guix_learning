...
/*  FUNCTION                                               RELEASE        */
/*                                                                        */
/*    _gx_display_driver_16bpp_glyph_1bit_draw                            */
/*                                                           6.3.0        */
/*  AUTHOR                                                                */
/*                                                                        */
...
void    (*blend_func)(GX_DRAW_CONTEXT *, INT, INT, GX_COLOR, GX_UBYTE);
    ...
    num_bytes = (UINT)(((INT)map_offset->x + (INT)pixel_per_row + 7) >> 3);
    ...
    if (map_offset->y)
    {
        glyph_row = (GX_UBYTE *)(glyph_row + ((INT)glyph_width * (INT)(map_offset->y)));
    }
    ...
    GX_CALCULATE_PUTROW(line_start, draw_area->left, draw_area->top, context);
