...
/*  FUNCTION                                               RELEASE        */
/*                                                                        */
/*    _gx_display_driver_1555xrgb_png_draw                                */
/*                                                           6.1          */
/*  AUTHOR                                                                */
/*                                                                        */
...
/*  DESCRIPTION                                                           */
/*                                                                        */
/*    1555xrgb format display driver PNG drawing function.                */
/*                                                                        */
/*  INPUT                                                                 */
/*                                                                        */
...
GX_PIXELMAP     pic_outmap;
    ...
    _gx_image_reader_create(&image_reader,
                            ...
                            GX_COLOR_FORMAT_1555XRGB, GX_IMAGE_READER_MODE_ALPHA);

    if (_gx_image_reader_start(&image_reader, &pic_outmap) == GX_SUCCESS)
    {
        _gx_display_driver_1555xrgb_pixelmap_draw(context, xpos, ypos, &pic_outmap);

        _gx_system_memory_free((void *)pic_outmap.data);

        if (pic_outmap.aux_data)
        {
            _gx_system_memory_free((void *)pic_outmap.aux_data);
        }
    }
}
#endif
