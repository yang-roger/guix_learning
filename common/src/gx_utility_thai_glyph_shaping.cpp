...
/*  FUNCTION                                               RELEASE        */
/*                                                                        */
/*    _gx_utility_thai_utf8_to_unicode                                    */
/*                                                           6.1          */
/*  AUTHOR                                                                */
/*                                                                        */
...
/**************************************************************************/
#ifdef GX_THAI_GLYPH_SHAPING_SUPPORT
static UINT _gx_utility_thai_utf8_to_unicode(const GX_STRING *string, GX_CHAR_CODE **returned_code_list, UINT *returned_code_count)
{
...
GX_BOOL       is_thai_string = GX_FALSE;
    ...
    while (string_copy.length > 0)
    {
        ...
        if (code_point == 0xe33)
        {
            code_list[code_count++] = (GX_CHAR_CODE)0xe4d;
            code_list[code_count++] = (GX_CHAR_CODE)0xe32;
        }
        else
        {
...
/*  FUNCTION                                               RELEASE        */
/*                                                                        */
/*    _gx_utility_thai_glyph_class_type_get                               */
/*                                                           6.1          */
/*  AUTHOR                                                                */
/*                                                                        */
/*    Kenneth Maxwell, Microsoft Corporation                              */
    ...
    if (status == GX_SUCCESS)
    {
        ...
        for (index = 0; index < code_count; index++)
        {
                    ...
                    (t == GX_THAI_GLYPH_CLASS_BASE_DESC))
                {
                    ...
                    if (t == GX_THAI_GLYPH_CLASS_BASE_ASC)
                    {
                        if (f_nikhahit)
                        {
                            ...
                            code_list[index] = (GX_CHAR_CODE)0xf711;
                            code_list[index + 2] = (GX_CHAR_CODE)0xe32;
                            index += 2;
                            pp_type = 0;
                            p_type = 0;
                            type = 0;
            ...
            else if ((p_type == GX_THAI_GLYPH_CLASS_BASE_ASC) && (type == GX_THAI_GLYPH_CLASS_UPPER))
            {
                ...
                {
                case 0xe31:
                    code_list[index] = (GX_CHAR_CODE)0xf710;
                    break;
                case 0xe34:
                case 0xe35:
                case 0xe36:
                ...
                case 0xe4d:
                    ...
                    break;
                case 0xe47:
                    code_list[index] = (GX_CHAR_CODE)0xf712;
                    break;
                }
            }
            ...
            else if ((code_list[index] == 0xe0d) && (f_type == GX_THAI_GLYPH_CLASS_LOWER))
            {
                ...
                code_list[index] = (GX_CHAR_CODE)0xf70f;
            }
            else if ((code_list[index] == 0xe10) && (f_type == GX_THAI_GLYPH_CLASS_LOWER))
            {
                ...
                /* base.desclike + lower --- base.descless. */
                code_list[index] = (GX_CHAR_CODE)0xf700;
            }
