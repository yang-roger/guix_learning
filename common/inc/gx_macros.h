...
#define GX_ASSERT_CONCAT_(a, b)  a##b
#define GX_ASSERT_CONCAT(a, b)  GX_ASSERT_CONCAT_(a, b)

#define GX_COMPILE_ASSERT(e)  enum { GX_ASSERT_CONCAT(gx_assert_line_, __LINE__) = 1/(int)(!!(e)) }
